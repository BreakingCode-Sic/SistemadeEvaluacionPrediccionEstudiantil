...
{Colors.CYAN}   🏫 [8]{Colors.ENDC} {Colors.BOLD}Ver estudiantes por área{Colors.ENDC}
{Colors.CYAN}   📖 [9]{Colors.ENDC} {Colors.BOLD}Ver estudiantes por asignatura{Colors.ENDC}
{Colors.CYAN}   ⚠️  [10]{Colors.ENDC} {Colors.BOLD}Estudiantes en riesgo{Colors.ENDC}
{Colors.RED}   🚪 [11]{Colors.ENDC} {Colors.BOLD}Salir del sistema{Colors.ENDC}
